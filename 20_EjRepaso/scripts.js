...
class Book {
    ...
    bookInfo() {
        return `El título del libro es ${this.title}, escrito por ${this.author} en el año ${this.year} y pertenece al género de ${this.gender}`
    }
}
...
while (books.length < 3) {
    let title = prompt('Introduce el título del libro').toLowerCase()
    let author = prompt('Introduce el autor del libro').toLowerCase()
    let year = prompt('Introduce el año del libro').toLowerCase()
